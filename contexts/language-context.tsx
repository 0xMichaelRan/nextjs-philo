...
const translations = {
  zh: {
    ...
    "home.deepAnalysis.title": "深度分析",
    "home.deepAnalysis.subtitle": "专业的电影解读",
    "home.deepAnalysis.description": "从多个维度解析电影的艺术价值和深层含义",
    "home.personalized.title": "个性定制",
    "home.personalized.subtitle": "量身打造的分析风格",
    "home.personalized.description": "选择您喜欢的叙述语调、分析角度和配音风格",
    "home.oneClick.title": "一键生成",
    "home.oneClick.subtitle": "简单快捷的创作流程",
    "home.oneClick.description": "几分钟内获得专业级的电影分析视频",
    "home.pickMovie": "选个电影",
    "home.login": "登录",
    "nav.jobPending": "任务队列",
    "nav.myVideos": "我的视频",
  ...
  en: {
    ...
    "home.deepAnalysis.title": "Deep Analysis",
    "home.deepAnalysis.subtitle": "Professional Movie Interpretation",
    "home.deepAnalysis.description": "Analyze artistic value and deep meanings from multiple dimensions",
    "home.personalized.title": "Personalized",
    "home.personalized.subtitle": "Tailored Analysis Style",
    "home.personalized.description": "Choose your preferred narrative tone, analysis angle, and voice style",
    "home.oneClick.title": "One-Click Generation",
    "home.oneClick.subtitle": "Simple and Fast Creation Process",
    "home.oneClick.description": "Get professional movie analysis videos in minutes",
    "home.pickMovie": "Pick a Movie",
    "home.login": "Login",
