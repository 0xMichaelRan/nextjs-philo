...
const translations = {
  zh: {
    ...
    // Home Page
    "home.title": "电影哲学家",
    "home.description": "让人工智能为您创作深度电影分析视频",
    "home.step1.title": "选择电影",
    "home.step1.description": "从热门电影库中选择，或搜索您感兴趣的任何电影作品开始分析之旅",
    "home.step2.title": "配置分析",
    "home.step2.description": "选择分析师角色、设定分析深度和风格，定制您的专属分析内容",
    "home.step3.title": "调整提示词",
    "home.step3.description": "精细调整AI分析提示词，确保生成的内容符合您的期望和要求",
    "home.step4.title": "选择配音",
    "home.step4.description": "从多种专业配音中选择，或录制自定义声音，为视频添加个人特色",
    "home.step5.title": "预览脚本",
    "home.step5.description": "查看AI生成的分析脚本，确认内容质量后提交视频制作任务",
    "home.step6.title": "等待生成",
    "home.step6.description": "视频正在后台制作中，您可以查看队列状态和预计完成时间",
    "home.step7.title": "观看视频",
    "home.step7.description": "视频制作完成！立即观看您的专属电影分析视频并分享给朋友",
    "home.pickMovie": "开始创作",
    "home.login": "登录",
    "nav.jobPending": "任务队列",
    "nav.myVideos": "我的视频",
    ...
    "movieSelection.movieInfo": "电影信息",
    "movieSelection.viewDetails": "查看详情",
    ...
    "videoGeneration.download": "下载视频",
    "videoGeneration.downloadSubtitles": "下载字幕",
    ...
    "videoGeneration.jobNotFound": "视频任务未找到",
    "videoGeneration.fetchFailed": "获取任务信息失败",
    "videoGeneration.preparingVideo": "正在准备视频...",
    "videoGeneration.generating": "视频生成中...",
    "videoGeneration.pleaseWait": "请耐心等待，视频正在处理中",
    "videoGeneration.jobInfo": "任务信息",
    "videoGeneration.resolution": "分辨率",
    "videoGeneration.speed": "语速",
    "videoGeneration.voice": "配音",
    ...
    "jobPending.timeUnknown": "时间未知",
    "jobPending.invalidTimeFormat": "时间格式错误",
    "jobPending.secondsAgo": "{seconds}秒前",
    "jobPending.minutesAgo": "{minutes}分钟前",
    "jobPending.hoursAgo": "{hours}小时前",
    "jobPending.daysAgo": "{days}天前",
    "jobPending.monthsAgo": "{months}个月前",
    "jobPending.aboutMinutes": "约 {minutes} 分钟",
    "jobPending.estimatedRemaining": "预计还需 {minutes} 分钟",
    "jobPending.justCreated": "刚刚创建",
    "jobPending.waitingFor": "等待了 {minutes} 分钟",
    "jobPending.waitingHours": "等待了 {hours} 小时 {minutes} 分钟",
    "jobPending.queueTitle": "任务队列",
    "jobPending.trackProgress": "查看您的视频生成进度",
    "jobPending.myVideos": "我的视频",
    "jobPending.jobStatus": "任务状态：",
    "jobPending.justCompleted": "刚完成 {count}",
    "jobPending.pending": "待处理 {count}",
    "jobPending.showFailed": "显示失败 {count}",
    "jobPending.hideFailed": "隐藏失败 {count}",
    "jobPending.submissionFailed": "提交失败",
    "jobPending.pendingJobsCount": "等待中任务",
    "jobPending.monthlyRemaining": "本月剩余",
    "jobPending.loadingJobs": "加载中...",
    "jobPending.createdAt": "创建于",
    "jobPending.updatedAt": "更新于",
    "jobPending.waitingTimeUnknown": "等待时间未知",
    "jobPending.progress": "进度",
    "jobPending.queuePosition": "队列位置: 第 {position} 位",
    "jobPending.estimatedWait": "预计等待时间",
    "jobPending.noJobsYet": "暂无任务",
    "jobPending.noJobsDescription": "您还没有创建任何视频任务",
    "jobPending.createVideo": "创建视频",
    "jobPending.status.draft": "草稿",
    "jobPending.status.pending": "待处理",
    "jobPending.status.queued": "排队中",
    "jobPending.status.processing": "处理中",
    "jobPending.status.completed": "已完成",
  ...
  en: {
    ...
    // Home Page
    "home.title": "Movie Philosopher",
    "home.description": "Let AI create deep movie analysis videos for you",
    "home.step1.title": "Choose Movie",
    "home.step1.description": "Select from popular movies or search for any film you're interested in to begin your analysis journey",
    "home.step2.title": "Configure Analysis",
    "home.step2.description": "Choose analyst character, set analysis depth and style to customize your unique analysis content",
    "home.step3.title": "Adjust Prompts",
    "home.step3.description": "Fine-tune AI analysis prompts to ensure the generated content meets your expectations and requirements",
    "home.step4.title": "Choose Voice",
    "home.step4.description": "Select from professional voice options or record custom voice to add personal character to your video",
    "home.step5.title": "Review Script",
    "home.step5.description": "Preview the AI-generated analysis script and confirm content quality before submitting video production",
    "home.step6.title": "Wait for Generation",
    "home.step6.description": "Video is being produced in the background. Check queue status and estimated completion time",
    "home.step7.title": "Watch Video",
    "home.step7.description": "Video production complete! Watch your personalized movie analysis video and share with friends",
    "home.pickMovie": "Start Creating",
    "home.login": "Login",
    ...
    "movieSelection.movieInfo": "Movie Info",
    "movieSelection.viewDetails": "View Details",
    ...
    // Video Generation
    "videoGeneration.title": "Video Generation",
    ...
    "videoGeneration.download": "Download Video",
    "videoGeneration.downloadSubtitles": "Download Subtitles",
    ...
    "videoGeneration.jobNotFound": "Video job not found",
    "videoGeneration.fetchFailed": "Failed to fetch job information",
    "videoGeneration.preparingVideo": "Preparing video...",
    "videoGeneration.generating": "Generating Video...",
    "videoGeneration.pleaseWait": "Please wait while your video is being processed",
    "videoGeneration.jobInfo": "Job Information",
    "videoGeneration.resolution": "Resolution",
    "videoGeneration.speed": "Speed",
    "videoGeneration.voice": "Voice",
    ...
    "jobPending.timeUnknown": "Unknown time",
    "jobPending.invalidTimeFormat": "Invalid time format",
    "jobPending.secondsAgo": "{seconds}s ago",
    "jobPending.minutesAgo": "{minutes}min ago",
    "jobPending.hoursAgo": "{hours}h ago",
    "jobPending.daysAgo": "{days}D ago",
    "jobPending.monthsAgo": "{months}M ago",
    "jobPending.aboutMinutes": "~{minutes} min",
    "jobPending.estimatedRemaining": "~{minutes} min remaining",
    "jobPending.justCreated": "Just created",
    "jobPending.waitingFor": "Waiting for {minutes} min",
    "jobPending.waitingHours": "Waiting for {hours}h {minutes}min",
    "jobPending.queueTitle": "Job Queue",
    "jobPending.trackProgress": "Track your video generation progress",
    "jobPending.myVideos": "My Videos",
    "jobPending.jobStatus": "Job Status:",
    "jobPending.justCompleted": "Completed {count}",
    "jobPending.pending": "Pending {count}",
    "jobPending.showFailed": "Show Failed {count}",
    "jobPending.hideFailed": "Hide Failed {count}",
    "jobPending.submissionFailed": "Submission Failed",
    "jobPending.pendingJobsCount": "Pending Jobs",
    "jobPending.monthlyRemaining": "Monthly Remaining",
    "jobPending.loadingJobs": "Loading jobs...",
    "jobPending.createdAt": "Created",
    "jobPending.updatedAt": "Updated",
    "jobPending.waitingTimeUnknown": "Waiting time unknown",
    "jobPending.progress": "Progress",
    "jobPending.queuePosition": "Queue position: #{position}",
    "jobPending.estimatedWait": "Estimated wait",
    "jobPending.noJobsYet": "No jobs yet",
    "jobPending.noJobsDescription": "You haven't created any video jobs yet",
    "jobPending.createVideo": "Create Video",
    "jobPending.status.draft": "Draft",
    "jobPending.status.pending": "Pending",
    "jobPending.status.queued": "Queued",
    "jobPending.status.processing": "Processing",
    "jobPending.status.completed": "Completed",
